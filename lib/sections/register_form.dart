                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            Ink(
                              child: InkWell(
                                onTap: () => _dialogBuilder(context, widget.data),
                        ...
                        onPressed: () {
                          if (!_isChecked1) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text("È obbligatorio acconsentire almeno al primo punto della liberatoria."),
                              ),
                            );
                          }
